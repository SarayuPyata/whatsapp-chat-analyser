...
def preprocess(data):
    ...
    if min_len == 0:
        print(
            "Warning: No messages or dates could be extracted using the specific format. Check the input file format and the pattern in preprocessor.py.")
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(
                    f"Error parsing dates: {e}. Could not match known formats including the specific Instamart format. Please double-check the date format in your chat file and adjust the format strings in preprocessor.py.")
